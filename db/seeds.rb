...
first_knowledge = Knowledge.create(y: 260, x: 250, character_name: "Oliver Puddlebrook", knowledge_blurb: "Clean aluminum cans and rinsed glass bottles can always be recycled.")
second_knowledge = Knowledge.create(y: 770, x: 315, character_name: "Felix Whimsy", knowledge_blurb: "Paper, including junk mail, can almost always be recycled. The only exceptions are shredded paper or paper that is contaminated (ie. food waste).")
third_knowledge = Knowledge.create(y: 720, x: 1800, character_name: "Penelope Puzzle", knowledge_blurb: "Recycling guidelines and rules are often determined by local laws and ordinances, so it's important to familiarize yourself with local recycling regulations.")
fourth_knowledge = Knowledge.create(y: 2055, x: 1480, character_name: "Amelia Starshine", knowledge_blurb: "Each ton of paper that is recycled saves seventeen trees.")
fifth_knowledge = Knowledge.create(y: 1800, x: 300, character_name: "Simon Feathers", knowledge_blurb: "When in doubt, do not recycle an item that you are unsure of.  This could contaminate the other items in the recycling bin.")
...
first_log=Recyclelog.create(user: first_user, date:'2023-07-15,16:45', amount:2)
second_log=Recyclelog.create(user: first_user, date:'2023-07-16,16:45', amount:6)
third_log=Recyclelog.create(user: first_user, date:'2023-07-21,16:45', amount:19)
fourth_log=Recyclelog.create(user: first_user, date:'2023-07-22,16:45', amount:22)
fifth_log=Recyclelog.create(user: first_user, date:'2023-07-23,16:45', amount:15)
sixth_log=Recyclelog.create(user: first_user, date:'2023-08-10,16:45', amount:35)
seventh_log=Recyclelog.create(user: first_user, date:'2023-08-15,16:45', amount:4)
eigth_log=Recyclelog.create(user: first_user, date:'2023-08-21,16:45', amount:8)

second_first_log=Recyclelog.create(user: second_user, date:'2023-07-15,16:45', amount:2)
second_second_log=Recyclelog.create(user: second_user, date:'2023-07-16,16:45', amount:6)
second_third_log=Recyclelog.create(user: second_user, date:'2023-07-21,16:45', amount:19)
second_fourth_log=Recyclelog.create(user: second_user, date:'2023-07-22,16:45', amount:22)
second_fifth_log=Recyclelog.create(user: second_user, date:'2023-07-23,16:45', amount:15)
second_sixth_log=Recyclelog.create(user: second_user, date:'2023-08-10,16:45', amount:35)
second_seventh_log=Recyclelog.create(user: second_user, date:'2023-08-15,16:45', amount:4)
second_eigth_log=Recyclelog.create(user: second_user, date:'2023-08-21,16:45', amount:8)

third_first_log=Recyclelog.create(user: third_user, date:'2023-07-15,16:45', amount:2)
third_second_log=Recyclelog.create(user: third_user, date:'2023-07-16,16:45', amount:6)
third_third_log=Recyclelog.create(user: third_user, date:'2023-07-21,16:45', amount:19)
third_fourth_log=Recyclelog.create(user: third_user, date:'2023-07-22,16:45', amount:22)
third_fifth_log=Recyclelog.create(user: third_user, date:'2023-07-23,16:45', amount:15)
third_sixth_log=Recyclelog.create(user: third_user, date:'2023-08-10,16:45', amount:35)
third_seventh_log=Recyclelog.create(user: third_user, date:'2023-08-15,16:45', amount:4)
third_eigth_log=Recyclelog.create(user: third_user, date:'2023-08-21,16:45', amount:8)

fourth_first_log=Recyclelog.create(user: fourth_user, date:'2023-07-15,16:45', amount:2)
fourth_second_log=Recyclelog.create(user: fourth_user, date:'2023-07-16,16:45', amount:6)
fourth_third_log=Recyclelog.create(user: fourth_user, date:'2023-07-21,16:45', amount:19)
fourth_fourth_log=Recyclelog.create(user: fourth_user, date:'2023-07-22,16:45', amount:22)
fourth_fifth_log=Recyclelog.create(user: fourth_user, date:'2023-07-23,16:45', amount:15)
fourth_sixth_log=Recyclelog.create(user: fourth_user, date:'2023-08-10,16:45', amount:35)
fourth_seventh_log=Recyclelog.create(user: fourth_user, date:'2023-08-15,16:45', amount:4)
fourth_eigth_log=Recyclelog.create(user: fourth_user, date:'2023-08-21,16:45', amount:8)

fifth_first_log=Recyclelog.create(user: fifth_user, date:'2023-07-15,16:45', amount:2)
fifth_second_log=Recyclelog.create(user: fifth_user, date:'2023-07-16,16:45', amount:6)
fifth_third_log=Recyclelog.create(user: fifth_user, date:'2023-07-21,16:45', amount:19)
fifth_fourth_log=Recyclelog.create(user: fifth_user, date:'2023-07-22,16:45', amount:22)
fifth_fifth_log=Recyclelog.create(user: fifth_user, date:'2023-07-23,16:45', amount:15)
fifth_sixth_log=Recyclelog.create(user: fifth_user, date:'2023-08-10,16:45', amount:35)
fifth_seventh_log=Recyclelog.create(user: fifth_user, date:'2023-08-15,16:45', amount:4)
fifth_eigth_log=Recyclelog.create(user: fifth_user, date:'2023-08-21,16:45', amount:8)
